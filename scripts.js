projectInfo = [
    ...
    ["Soft Body Physics Engine", "A physics engine built completely from scratch, made up of point masses and springs that connect to form shapes and interact with each other.", "assets/softBodyPhysics.gif", "https://github.com/liamb09/soft-body-physics", ["cpp"]],
    ["Bread Log Manager", "A Google Apps Script web app that enables me to add formatted entries to my sourdough bread log from my phone. Instructions to use it for yourself can be found on the GitHub.", "assets/breadLogManager.jpg", "https://github.com/liamb09/bread-log-manager", ["appsscript", "html", "css", "js"]],
    ["Rundex", "A running log app made with flutter featuring many capabilities such as adding sets to your workout, custom routes, and more.", "assets/rundex.png", "https://github.com/liamb09/Rundex", ["flutter"]],
